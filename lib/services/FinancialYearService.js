...
/** The Financial Year immediately preceding this one (by date), if any — for comparative statements. */
export async function getPreviousFinancialYear(societyId, financialYear) {
  return FinancialYear.findOne({
    societyId,
    isDeleted: false,
