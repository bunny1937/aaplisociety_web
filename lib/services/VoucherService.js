...
export async function createDraftVoucherWithinSession(
  session,
  {
    ...
    // Auditor Mode's sanctioned bypass (Phase 2.19) — see AccountingEngine.js's
    // process() docstring. Never set true by any other caller.
    allowLockedFinancialYear = false,
  },
) {
