...
export default function renderBillHtml(
  ...
  const gracePeriod = config.gracePeriodDays || 10;
  ...
  <div style="padding:40px;background:white;page-break-after:always;">
    ...
    <div style="background:#fee2e2;border:1px solid #fca5a5;border-left:5px solid #dc2626;padding:20px 24px;border-radius:8px;margin-bottom:20px;">
      ...
      <div style="background:rgba(255,255,255,0.5);border-radius:6px;padding:12px 16px;font-size:12px;color:#7f1d1d;line-height:1.7;">
        <strong>Interest Calculation:</strong> ₹${(data.previousBalance || 0).toLocaleString("en-IN")} × ${interestRate}% p.a. (${interestMethod})
        ${
          monthInterest > 0
            ? ` × ${interestRate} ÷ 1200 = <strong>₹${monthInterest.toLocaleString("en-IN", { minimumFractionDigits: 2 })}</strong>`
  ...
  <div style="padding:40px;background:white;border-top:4px solid #1e40af;margin-top:4px;">
    ...
    <div style="background:#fef9c3;border:1px solid #fde68a;border-radius:8px;padding:20px 24px;margin-bottom:28px;">
      ...
      <table style="width:100%;font-size:13px;border-collapse:collapse;">
        <tr><td style="padding:7px 12px;color:#6b7280;width:45%;">Principal (Outstanding Balance)</td><td style="padding:7px 12px;font-weight:600;">₹${(data.previousBalance || 0).toLocaleString("en-IN", { minimumFractionDigits: 2 })}</td></tr>
        ...
        <tr style="background:rgba(0,0,0,0.03)"><td style="padding:7px 12px;color:#6b7280;">Grace Period</td><td style="padding:7px 12px;font-weight:600;">${gracePeriod} days (interest-free)</td></tr>
