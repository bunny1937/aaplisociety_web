...
export const EVENT_TYPES = Object.freeze({
  ...
  // Phase 2.12 — Liability Register (vendor payables, loans, deposits,
  // advance collections, statutory taxes).
  LIABILITY_INCURRED: "LiabilityIncurred",
  LIABILITY_PAYMENT_MADE: "LiabilityPaymentMade",
});
